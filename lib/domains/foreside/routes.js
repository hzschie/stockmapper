...
module.exports = function(app) {
  app.get('/home.html', function(req, res) {
    res.render('domains/foreside/home');
  });

  app.get('/about.html', function(req, res) {
    // var url = 'http://localhost:3000/active/USO';
    ...
    //         // body += chunk;
    //         console.log(chunk['USO']);
    //         res.render('domains/foreside/about', {quote: 'ss'});
    //     });
    ...
    res.render('domains/foreside/about');
  });
